    ...
    return range(pair[0], pair[1]).map((num, idx) => {
      ...
      return (
        <Page
          ...
          index={idx}
          isActive={isActive}
          className="page-item btn-numbered-page"
          onClick={onClick}
        >{num}</Page>
      );
    });
    ...
    return (
      <nav>
        <ul className={className}>
          <Page
            className="page-item btn-first-page"
            key="btn-first-page"
          ...
          <Page
            className="page-item btn-prev-page"
            key="btn-prev-page"
            isDisabled={this.isPrevDisabled()}
          ...
          <Page
            className="page-item btn-prev-more"
            key="btn-prev-more"
          ...
          <Page
            className="page-item btn-next-more"
            key="btn-next-more"
          ...
          <Page
            className="page-item btn-next-page"
            key="btn-next-page"
          ...
          <Page
            className="page-item btn-last-page"
            key="btn-last-page"
            isDisabled={this.isNextDisabled()}
